...
# These functions are imported on-demand in methods that use them
from maskpolicy.utils.utils import deserialize_json_into_object
...
def _save_single_optimizer_state(optimizer: torch.optim.Optimizer, save_dir: Path) -> None:
    ...
    from maskpolicy.datasets.utils import flatten_dict
    flat_state = flatten_dict(state)
    save_file(flat_state, save_dir / OPTIMIZER_STATE)
    from maskpolicy.datasets.utils import write_json
...
def _load_single_optimizer_state(optimizer: torch.optim.Optimizer, save_dir: Path) -> torch.optim.Optimizer:
    ...
    from maskpolicy.datasets.utils import unflatten_dict
