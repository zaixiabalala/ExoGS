...
def get_config():
    ...
    config = {
        'GS_dir': r"/media/ubuntu/B0A8C06FA8C0361E/Data/example/GSData",  # Output directory
        'Origin_dir': r"/media/ubuntu/B0A8C06FA8C0361E/Data/example/OriginData",  # Source data directory
        'records_name': "records_example",  # Records folder name
        'robot_type': "franka",
        'force_overwrite': True,  # If True, delete existing records folder before rendering
        'scene_name': "scene_none",  # Scene name
        'objects': ['plate', "banana"],  # Object list
        ...
        'color_index_list': [0, 1],  # Color variant indices
        ...
        'bg_image_index_list': [1, 2],  # Background image indices
        'color_ranges': {
